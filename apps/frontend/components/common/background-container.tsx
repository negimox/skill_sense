...
const BackgroundContainer = ({
  ...
  return (
    <section
      className={cn(
        'relative flex h-screen items-center justify-center overflow-hidden p-2 bg-gradient-to-br from-blue-600 via-orange-400 to-purple-700',
        className
      )}
    >
      ...
      >
        {/* Dot pattern component for visual effect - no animation */}
        <DotPattern
