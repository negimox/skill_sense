...
class GitHubTopRepository(BaseModel):
    name: str
    description: Optional[str] = None
    stars: int = 0
...
class GitHubProfileSummary(BaseModel):
    """Summary of GitHub profile data for resume display"""
    ...
    topRepositories: List[GitHubTopRepository] = []
    recentContributions: Optional[int] = None
...
class ResumePreviewerModel(BaseModel):
    ...
    githubProfile: Optional[GitHubProfileSummary] = None
